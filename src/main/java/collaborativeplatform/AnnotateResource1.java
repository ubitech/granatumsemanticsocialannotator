...
public class AnnotateResource1
extends HttpServlet
{
...
/*        
  ...
  */      
        try {
            ...
            Logger.getLogger(AnnotateResource1.class.getName()).log(Level.SEVERE, null, ex);
...
//        sparqlCache = SPARQLCacheEndpoint.getCacheEndpoint();
    ...
    throws ServletException, IOException, SQLException
    {
        ...
        String sioc = (String)session.getAttribute("sioc");
...
//        sparqlInterface = new DataCloudSPARQLInterface(fileMIMEtype, category, categoryMappings);
    ...
    */
    ...
    throws ServletException, IOException, XmlRpcException
    {
        ...
        topics = new String(getURIs((String)request.getParameter("selections"), suggestions)+ " " + conceptTypeMappings.getConcept(filemimetype));
        CollaborativePlatformInterface collPlatform = new CollaborativePlatformInterface(password, username);
//        newObjectID = collPlatform.editAnnotation(objectID, subject, body, topics, lbds);
//        SIOCdata = collPlatform.retrieveSIOCfromPlatform(newObjectID);
...
//        SIOCdata = collPlatform.retrieveSIOCfromPlatform(newObjectID);
//        session.setAttribute("sioc", SIOCdata);
//        collPlatform.uploadFIleFromURL("10210", "testrdf", "http://localhost:8080/SemanticSocialAnnotator/AnnotateResource?op=provideSIOC");
//        System.out.println(SIOCdata);
    ...
    private String getURIs(String selection, HashMap<String,String> suggestions)
    {
        ...
        {
            topics += suggestions.get(selectionArray[i].substring(0,selectionArray[i].length()-1)) + " ";
            System.out.println(" --- " + selectionArray[i].substring(0,selectionArray[i].length()-1) + " " + suggestions.get(selectionArray[i].substring(0,selectionArray[i].length()-1)));
        }        
    ...
    throws ServletException, IOException, XmlRpcException, Throwable
    {
        ...
        // this will be deleted/change before making the code live
        ///////////////////////////////////////////////////////
...
//        fileMIMEtype = collPlatform.retrieveMIMEType(objectID);
