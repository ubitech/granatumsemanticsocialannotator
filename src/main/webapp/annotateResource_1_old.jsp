...
<script type="text/javascript" src="http://www.granatum.org/pub/static/javascript/dojo/dojo/dojo.js"></script>
<script type="text/javascript" src="http://www.granatum.org/pub/static/javascript/dojo/dojo/dojo_base.js"></script>
<script>
...
//<![CDATA[
                ...
                dojo.addOnLoad(function(){
                    xInputSubmitEvent('queryfield','op_qsearch',300);
                });
            
//]]>
</script>
<script type="text/javascript" src="http://www.granatum.org/pub/static/javascript/init.js"></script>
...
<script type="text/javascript" src="http://www.granatum.org/pub/static/javascript/dojo/dojo/dojobscw-core-gui.js"></script>
<script type="text/javascript" src="http://www.granatum.org/pub/static/javascript/dojo/dojo/dojobscw-core.js"></script>
<script type="text/javascript">
//<![CDATA[

            dojo.require("dojobscw.parser");
            dojo.require("dojobscw.remote.BSCW");
            dojo.addOnLoad(function(){
                dojo.addClass(dojo.body(), "tundra");
                new dojobscw.remote.BSCW();
                dojobscw.parser.parseLazy(dojo.body(),
                           dojobscw.parser.ignoreDecisionMaker);
...
//<![CDATA[
 ...
 dojo.require("dojobscw.upload.Dropper");
 dojo.require("dojobscw.upload.UploadDialog");
 dojo.require("dojobscw.navigator.Navigator");
 dojo.require("dojobscw.operations.OperationDialog");
 dojo.require("dojobscw.operations.HoverToolbar");if ((parent != window) && parent.OperationDialogResize) {
    var href = window.location.href + "&";
    href = href.replace(/inside_dialog=.*?\&/g, '');
    href = href.replace(/client_size=.*?\&/g, '');
    while ((href[href.length-1] == '?') || (href[href.length-1] == '&'))
...
//<![CDATA[
                ...
                dojo.query("input[type=text]").connect("keypress", function(e){
